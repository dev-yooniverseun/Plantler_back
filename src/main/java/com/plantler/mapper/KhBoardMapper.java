...
//	public KhBoardDTO findOne(int board_no);
	...
	@Insert("INSERT INTO pl_file (board_no, file_server_name, file_name, file_type, file_url, file_extension, file_sort, file_content) VALUE (#{board_no}, #{file_server_name}, #{file_name}, #{file_type}, #{file_url}, #{file_extension}, #{file_sort}, #{file_content})")
	...
	//게시판 상단 랭킹 1 TO 10
//	@Select("SELECT * FROM pl_board ORDER BY board_count DESC LIMIT 10")
//	public List<KhBoardDTO> KhTop10ByBoardCount(int limit);
...
//	public int KhTop10FileNo(FileDTO fileDTO);
//
//
//	public FileDTO KhTop10FileNo();
}
...
//		@Result(property = "board_file_server_name", column = "board_file_server_name")
//	})